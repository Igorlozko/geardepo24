...
const AddReservations = () => {
    const {state:{resDetails, dateRange, currentUser,gear,paymentMethod},dispatch} = useValue();
    ...
    const handleSubmit = (paymentMethod)=>{
        ...
        console.log('Payment method in add',paymentMethod)
        createReservation(reservation, currentUser,paymentMethod, dispatch)
    };
